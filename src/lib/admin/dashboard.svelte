...
{#if admin_stats}
    <div class="admin-dashboard">
        ...
        <div class="stat-grid">
            <div class="stat-card">
              <h4>Total Users</h4>
              <p>{admin_stats.total_users ?? 0}</p>
            </div>
            <div class="stat-card">
              <h4>Total Posts</h4>
              <p>{admin_stats.total_posts ?? 0}</p>
            </div>
          </div>
